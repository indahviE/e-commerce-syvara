        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Perbarui kode voucher dan detail diskonnya.</p>
                </div>
            ...
            <div class="rounded-3xl bg-white border border-pink-100 p-8 shadow-sm">
                <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode" value="{{ old('kode', $voucher->kode) }}" class="mt-3 w-full rounded-2xl border border-pink-200 bg-pink-50 px-4 py-3" placeholder="Masukkan kode voucher" />
                    ...
                    <div>
                        ...
                        <input type="number" name="discount" value="{{ old('discount', $voucher->discount) }}" min="0" max="100" class="mt-3 w-full rounded-2xl border border-pink-200 bg-pink-50 px-4 py-3" placeholder="Contoh: 20" />
                    ...
                    <div>
                        ...
                        <select name="is_expired" class="mt-3 w-full rounded-2xl border border-pink-200 bg-pink-50 px-4 py-3">
                            <option value="0" {{ old('is_expired', $voucher->is_expired) == '0' ? 'selected' : '' }}>Aktif</option>
                            <option value="1" {{ old('is_expired', $voucher->is_expired) == '1' ? 'selected' : '' }}>Expired</option>
                        </select>
